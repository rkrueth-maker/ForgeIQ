/** Business Office focused app registry.
 *
...
function boGetBusinessAppCatalog_() {
  const apps = [
    ...
    {key:'work-manager',name:'Work Manager',shortName:'Work',tagline:'Work orders, jobs, assignments, checklists, and controlled completion.',modules:['workOrders','jobs','time','documents'],tier:'Core',standaloneCapable:true,icon:'WM'},
    ...
    {key:'field-proof',name:'Field Proof',shortName:'Field Proof',tagline:'Job photos, document proof, visibility controls, and completion evidence.',modules:['jobs','workOrders','documents'],tier:'Entry',standaloneCapable:true,icon:'FP'},
    ...
    {key:'approval-center',name:'Approval Center',shortName:'Approvals',tagline:'Owner-controlled decisions, limits, proof history, and external-action gates.',modules:['approvals','quotes','purchaseOrders','invoices','documents','setup'],tier:'Advanced',standaloneCapable:true,icon:'AC'},
    ...
    {key:'maintenance-manager',name:'Maintenance Manager',shortName:'Maintenance',tagline:'Assets, preventive work, service history, parts, documents, and recurring controls.',modules:['workOrders','jobs','vendors','documents','expenses'],tier:'Advanced',standaloneCapable:true,icon:'MM'},
    {key:'shop-flow-manager',name:'Shop Flow Manager',shortName:'Shop Flow',tagline:'Work centers, routing, bottlenecks, downtime, tooling, and improvement actions.',modules:['jobs','workOrders','time','documents','reports'],tier:'Advanced',standaloneCapable:true,icon:'SF'},
    {key:'business-system',name:'Business System',shortName:'Business System',tagline:'All focused apps connected through one controlled platform.',modules:['requests','customers','vendors','quotes','workOrders','jobs','purchaseOrders','vendorBills','receipts','expenses','invoices','payments','time','employees','payroll','contractors','tax','documents','accounting','approvals','reports','setup'],tier:'Suite',standaloneCapable:false,icon:'BO'}
  ];
