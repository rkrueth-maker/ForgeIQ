...
function boGetBusinessAppCatalog_() {
  const apps = [
    ...
    {key:'work-manager',name:'Highway 38 Work Manager',shortName:'Work',tagline:'Work orders, jobs, assignments, checklists, and controlled completion.',modules:['assignedTasks','workOrders','jobs','time','documents'],tier:'Core',standaloneCapable:true,icon:'WM'},
    {key:'field-operations',name:'Highway 38 Field Operations',shortName:'Field',tagline:'Assigned work, time clock, required progress proof, receipts, issues, and controlled closeout.',modules:['assignedTasks','time','jobs','workOrders','documents','receipts'],tier:'Core',standaloneCapable:true,icon:'FO'},
    ...
    {key:'shop-flow-manager',name:'Highway 38 Shop Flow Manager',shortName:'Shop Flow',tagline:'Work centers, routing, bottlenecks, downtime, tooling, and improvement actions.',modules:['jobs','workOrders','assignedTasks','time','documents','reports'],tier:'Advanced',standaloneCapable:true,icon:'SF'},
    {key:'business-system',name:'Highway 38 Business System',shortName:'Business System',tagline:'All focused apps connected through one controlled platform.',modules:['requests','customers','vendors','quotes','assignedTasks','workOrders','jobs','purchaseOrders','vendorBills','receipts','expenses','invoices','payments','time','employees','payroll','contractors','tax','documents','social','accounting','approvals','reports','setup'],tier:'Suite',standaloneCapable:false,icon:'H38'}
  ];
