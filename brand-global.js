(()=>{
  'use strict';
  if(/\/businesses\//.test(location.pathname))return;
  function loadCanonicalSite(){
  ...
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',loadCanonicalSite,{once:true});
  else loadCanonicalSite();
})();
