...
const required = ['Backend_Config.gs','Backend_Repository.gs','Backend_Intake.gs','Backend_Workflows.gs','Backend_PortalBridge.gs','Backend_Setup.gs','appsscript.json','README.md'];
const failures = [];
...
const must = ['Owner Approval Required','LIVE_EXTERNAL_ACTIONS_ENABLED: false','H38_BACKEND_OWNER_EMAILS','H38_INTAKE_FORM_ID','Idempotency Key','LockService.getScriptLock','h38BackendOnFormSubmit','INSTALL APPROVED FORM TRIGGER','Portal Leads','Portal Jobs','AUTHORIZE FULFILLMENT START','BLOCKED — OWNER APPROVAL REQUIRED','h38BackendBusinessOsSnapshot'];
