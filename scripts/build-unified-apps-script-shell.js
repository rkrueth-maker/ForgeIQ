...
const result = {status:'PASS',sourceCommit:process.env.GITHUB_SHA||'',projectDir,shell:'Unified_AppShell.gs',entryPoints,legacyPortalBridgeRemoved:true,standaloneEntriesRenamed:{ownerPortal:'h38PortalStandaloneDoGet_',businessOffice:'boBusinessOfficeStandaloneDoGet_'},capabilityOwner:{quotes:'quoteBuilder when enabled; legacyQuotes otherwise'},customerProposalRoute:'public token validated by commercial proposal engine',externalActionsEnabled:false};
