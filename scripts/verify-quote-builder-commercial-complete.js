...
need(gate,'quoteCommercialPrepareShare','commercial module guard');
...
console.log('PASS — commercially complete Quote Builder proposal lifecycle, controlled sharing, options, add-ons, photos, preview, signature, PDF, timeline, and follow-up controls verified.');