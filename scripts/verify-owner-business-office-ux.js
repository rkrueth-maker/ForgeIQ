...
check('Owner Portal grouped navigation',['Command Center','Sales & Customers','Work & Purchasing','Revenue & Accounting','People & Tax','Documents','Website & Growth','Proof & Control'].every(text=>ownerUnified.includes(text))&&ownerClient.includes('nav-group'));
