(function(){
  ...
  const statusCard='<article class="eco-card"><div class="eco-meta"><span class="eco-proof-label">Evidence pass status</span><span class="eco-chip eco-chip--ok">FAIL CLOSED</span></div><h3>Connected Drive review complete; original PST still unavailable</h3><p>The available private Drive evidence pass indexed 12 source records, reviewed 10 claims, classified 18 still images, and registered three videos on hold. No reviewed raw image or video was approved for publication.</p><p>The original backup.pst is not available to the current system and has not been hashed, copied, extracted, or indexed. PST message and attachment counts remain zero until the untouched original is provided privately.</p></article>';
